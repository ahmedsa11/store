...
function AddProductHook() {
  ...
  return [loading, isPress,setImages, onSelectsubcat, onRemovesubcat, options, handleColors, removeColors, onSelectCategory, handleSubmit, onSelectBrand,onChangeDesName, onChangeQty, onChangeColor, onChangePriceAfter, onChangePriceBefor, onChangeProdName, showPic, Category, Brand, PriceAfter, images, colors, PriceBefore, Qty, ProdDescription, ProdName]
}
