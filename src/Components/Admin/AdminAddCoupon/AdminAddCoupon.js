...
import AdminCoupnCard from '../AdminCouponCard/AdminCouponCard';
const AdminAddCoupon = () => {
    const dateRef = useRef();
    const [coupnName, couponDate, couponValue, onChangeName, onChangeDate, onChangeValue, onSubmit, coupons,getPage,PageCount] = AddCouponHook ()
    return (
        <div>
           ...
           {coupons<=0?null: <Pagination PageCount={PageCount}onPress={getPage} />}
            <ToastContainer />
        </div>
    )
}
