...
const CartItem = ({item}) => {
  const [, show, handleClose, handleShow, handelDeleteItem, itemCount, onChangeCount, handeleUpdateCart] = DeleteCartHook(item)
    ...
    return (
      ...
      <img width="160px" height="197px" src={item.product.image || mobile} alt="" />
      <div className="w-100">
